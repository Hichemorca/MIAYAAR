...
- [ ] U-007 post-deployment verification: retrieve and archive the first production `[Server connection role evidence]` record through an authorised Netlify log-reading path; do not infer its outcome from deployment metadata alone.

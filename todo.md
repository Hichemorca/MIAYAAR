...
- [ ] U-010 NOLOGIN administrative package: document the current executor-permission blocker and prepare only the administrator SQL, pre-checks, post-checks, application non-impact verification, and single-attribute change record; do not execute SQL or alter code, migrations, connection settings, credentials, membership, grants, or RLS policies.

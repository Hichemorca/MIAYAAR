AQAR Valuation Engine — Methodology

---

Version: 1.0
Status: Frozen
Owner: AQAR Engineering
Last Review: 2026-08-04
Next Review: 2027-02-04
Document ID: AQAR-METH-001
...
This document defines the valuation methodology implemented in the AQAR Valuation Engine. It is the single source of truth for all calculation logic, adjustment factors, and weighting decisions. Implementations must conform to this specification.
...
1.0 2026-08-04 AQAR Engineering Initial frozen version
